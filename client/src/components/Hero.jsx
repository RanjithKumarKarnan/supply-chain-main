            ...
            >
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                    <div className="mb-8">
                        ...
                        <p
                            className={`text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed transform transition-all duration-1000 delay-500 ${
                                isVisible
                                    ? "translate-y-0 opacity-100"
                                    : "translate-y-20 opacity-0"
                            }`}
                        >
                            ...
                            <span className="relative mx-2">
                                <span className="text-[#bf272f] font-semibold">
                                    startups, expos & corporate teams
                                </span>
                    ...
                    >
                        <button
                            ...
                            className="group relative px-8 py-4 bg-gradient-to-r from-[#bf272f] via-red-600 to-[#bf272f] text-white font-bold rounded-full overflow-hidden transform transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-[#bf272f]/30"
                        >
                    ...
                    >
                        <div className="flex flex-col items-center space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <ChevronDown
                                    className="w-6 h-6 text-white/20 animate-bounce absolute inset-0"
